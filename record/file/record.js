...
$(document).ready(function() {
    ...
    $(document).on("click", "#record:not(.disabled)",
    function() {
        elem = $(this);
    ...
    $(document).on("click", "#pause:not(.disabled)",
    function() {
    ...
    $(document).on("click", "#stop:not(.disabled)",
    function() {
        restore();
    });
    $(document).on("click", "#play:not(.disabled)",
    function() {
    ...
    $(document).on("click", "#download:not(.disabled)",
    function() {
        Fr.voice.export(function(url) {
    ...
    $(document).on("click", "#base64:not(.disabled)",
    function() {
        Fr.voice.export(function(url) {
    ...
    $(document).on("click", "#mp3:not(.disabled)",
    function() {
    ...
    $(document).on("click", "#save:not(.disabled)",
    function() {
